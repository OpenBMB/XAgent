        ...
        *,
        ...
        if (
            ...
            if hash_key in pstate_to_vocab_path_cache:
                ...
                regex_fsm,self.states_to_token_maps,self.empty_token_ids = pstate_to_vocab_path_cache[hash_key]
                ...
                self.initial_state = regex_fsm.initial
                self.final_states = regex_fsm.finals
                pstate_to_vocab_path_cache[hash_key] = (regex_fsm,self.states_to_token_maps,self.empty_token_ids)
        else:
