...
class PlanAgent:
    def __init__(
        self, config, query: BaseQuery, avaliable_tools_description_list: List[dict]
    ):
        self.config = config
        self.query = query
        ...
        new_message, _ = agent.parse(
            placeholders={
                "system": {
                    ...
                    "avaliable_tool_names": str(
                        [cont["name"] for cont in self.avaliable_tools_description_list]
                    ),
                },
                "user": {"query": self.plan.data.raw},
            },
            arguments=deepcopy(
                ...
                placeholders={
                    "system": {
                        ...
                        "avaliable_tool_names": str(
                            [
                                cont["name"]
                                for cont in self.avaliable_tools_description_list
                            ]
                        ),
